...
export default function LoginScreen({ navigation}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput style={styles.input} placeholder='ID' value={username} onChangeText={setUsername}/>
            <TextInput style={styles.input} placeholder='PW' value={password} onChangeText={setPassword} secureTextEntry/>
